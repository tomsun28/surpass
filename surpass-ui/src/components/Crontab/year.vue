...
const fullYear: any = ref(0)
const maxFullYear: any = ref(0)
const radioValue: any = ref(1)
const cycle01: any = ref(0)
const cycle02: any = ref(0)
const average01: any = ref(0)
const average02: any = ref(1)
const checkboxList: any = ref<any>([])
const checkCopy: any = ref<any>([])
...
watch(() => props.cron.year, (value: any) =>  changeRadioValue(value))
