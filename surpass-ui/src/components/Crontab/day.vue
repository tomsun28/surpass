...
const cycle01: any = ref(1)
const cycle02: any = ref(2)
const average01: any = ref(1)
const average02: any = ref(1)
const workday: any = ref(1)
const checkboxList: any = ref<any>([])
const checkCopy: any = ref([1])
...
const workdayTotal: any = computed(() => {
...
watch(() => props.cron.day, (value: any) =>  changeRadioValue(value))
...
function changeRadioValue(value: any): any {
    if (value === "*") {
        ...
        const indexArr: any = value.split("W")
