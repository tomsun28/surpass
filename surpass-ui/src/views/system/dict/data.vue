...
const dataRef = ref<InstanceType<typeof ElForm> | null>(null);
...
/** 查询字典类型详细 */
function getTypes(dictId: any): any {
...
function handleClose(): any {
  const obj: any = { path: "/system/dict" };
