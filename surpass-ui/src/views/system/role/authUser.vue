...
function handleClose(): any {
  const obj: any = { path: "/system/role" };
...
/** 打开授权用户表弹窗 */
function openSelectUser(): any {
  proxy.$refs["selectRef"].show();
}

/** 取消授权按钮操作 */
function cancelAuthUser(row: any): any {
...
/** 批量取消授权按钮操作 */
function cancelAuthUserAll(row: any): any {
  const roleId: any = queryParams.roleId;
  const uIds: any = userIds.value.join(",");
