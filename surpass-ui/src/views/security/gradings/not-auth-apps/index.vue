  ...
  >
    <div class="app-container1" style="margin-top: -10px">
      <el-form :model="queryParams" ref="queryRef" :inline="true">
        <el-form-item :label="t('jbx.apps.appName')" prop="gradingName">
          <el-input
...
<script setup name="gradings-not-auth-apps" lang="ts">
import { useRoute, useRouter } from "vue-router";
import {ref, getCurrentInstance, reactive, toRefs, watch, defineComponent} from "vue";
import modal from "@/plugins/modal";

import {apiAppGetOut} from "@/api/security/gradings";
...
function getList(): any {
  ...
  apiAppGetOut(queryParams.value).then((res: any) =>  {
    loading.value = false;
    if (res.code === 2) {
