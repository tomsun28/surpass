  ...
  <div class="app-container">
    <el-card class="common-card">
      <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch">
        <el-form-item :label="$t('jbx.configweakpassword.password') + '：'" prop="password">
          <el-input
    ...
    <el-card class="common-card">
      ...
      <el-table v-loading="loading" :data="list" @selection-change="handleSelectionChange">
        ...
        <el-table-column :label="$t('jbx.configweakpassword.password')" align="left" prop="password"/>
        <el-table-column :label="$t('jbx.configweakpassword.sortIndex')" align="center" prop="sortIndex"/>
        <el-table-column :label="$t('jbx.configweakpassword.status')" align="center" prop="status">
    ...
    <el-dialog :title="title" v-model="open" width="600px" append-to-body>
      <el-form ref="formRef" :model="form" :rules="rules" label-width="120px">
        ...
        <el-form-item :label="$t('jbx.configweakpassword.sortIndex')" prop="sortIndex">
          <el-input-number v-model="form.sortIndex" placeholder=""/>
        </el-form-item>
        <el-form-item  :label="$t('jbx.configweakpassword.status')" prop="status">
          <el-switch
            v-model="form.status"
            :active-value="1"
            :inactive-value="0"
...
<script setup name="ConfigweakPassword" lang="ts">
...
import {
  ...
  deleteById,
  create
} from "@/api/security/configweakpassword";
...
const data: any = reactive({
  ...
  rules: {
    password: [{ required: true, message: 'Not empty', trigger: "blur" }],
    sortIndex: [{ required: true,message: 'Not empty',  trigger: "blur" }],
