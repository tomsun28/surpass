...
public interface SettlementCarryService extends IService<Settlement> {

	Message<Page<SettlementCarryforwardVo>> fetchCarry(VoucherTemplatePageDto dto);

    Message<String> generateVoucher(GenerateVoucherDto dto);

    Message<String> delete(String bookId,String voucherId);
