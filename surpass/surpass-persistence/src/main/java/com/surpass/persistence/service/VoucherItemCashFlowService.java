...
public interface VoucherItemCashFlowService extends IService<VoucherItemCashFlow> {
    Message<String> specifyCashFlowItems(VoucherItemCashFlowDto dto);

    Message<List<VoucherItemVo>> getCashFlowItems(VoucherItemPageDto dto);
}
