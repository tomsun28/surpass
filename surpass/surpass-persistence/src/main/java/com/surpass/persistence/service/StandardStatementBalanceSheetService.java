 ...
 * 财务报表配置业务接口
 */
public interface StandardStatementBalanceSheetService {
    Message<StandardStatementBalanceSheet> get(StandardStatementBalanceSheet dto);

    /**
     * 资产负载表配置
     */
    Message<StandardStatementBalanceSheet> save(StandardStatementBalanceSheet dto);
    ...
    Message<StandardStatementBalanceSheetListVo> list(StandardStatementBalanceSheet dto);
