...
public interface BookService extends IService<Book> {
    Message<Page<Book>> pageList(BookPageDto dto);

    Message<String> save(BookChangeDto dto);

    Message<String> update(BookChangeDto dto);

    Message<String> delete(ListIdsDto dto);

    List<BookVo> listBooks(String userId);
}
