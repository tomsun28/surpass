...
public interface VoucherTemplateItemService extends IService<VoucherTemplateItem> {
    Message<Page<VoucherTemplateItem>> pageList(VoucherTemplateItemPageDto dto);

    Message<String> save(VoucherTemplateItemChangeDto dto);

    Message<String> update(VoucherTemplateItemChangeDto dto);
