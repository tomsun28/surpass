 ...
 * 初始余额服务
 */
public interface BookInitBalanceService extends IService<BookInitBalance> {
    Message<List<BookInitBalanceVo>> list(BookInitBalancePageDto dto);
    Message<String> save(List<BookInitBalanceChangeDto> dtos);
}
