...
package org.dromara.surpass.crypto.keystore;

import org.apache.commons.codec.binary.Base64;
import org.bouncycastle.openssl.PEMParser;
import org.dromara.surpass.crypto.Base64Utils;
import org.dromara.surpass.crypto.cert.CryptoException;
import org.dromara.surpass.crypto.cert.X509CertUtils;
import org.dromara.surpass.crypto.cert.X509V3CertGen;
...
public final class KeyStoreUtil {
    ...
    public static KeyStore importTrustCertificate(KeyStore keyStore, X509Certificate trustCert, String sCertAlias) {
        ...
        try {
            ...
            sMatchAlias = X509CertUtils.matchCertificate(keyStore, trustCert);
            logger.debug("sMatchAlias : " + sMatchAlias);
            if (sMatchAlias != null) {
