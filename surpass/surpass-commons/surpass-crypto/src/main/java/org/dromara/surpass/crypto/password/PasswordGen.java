...
package org.dromara.surpass.crypto.password;
...
public class PasswordGen {
    ...
    public static final String CHAR_UPPERCASE 	= "ABCDEFGHIJKLMNOPQRSTUVWXYZ";
    public static final String CHAR_NUMBERS 	= "0123456789";
    public static final String CHAR_SPECIAL 	= "~@#^()[]*$-+?_&=!%{}/";
    public static final String CHAR_DEFAULT 	= CHAR_LOWERCASE + CHAR_NUMBERS + CHAR_UPPERCASE;
