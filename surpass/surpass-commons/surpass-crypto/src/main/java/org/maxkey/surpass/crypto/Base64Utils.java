...
package org.maxkey.surpass.crypto;
...
public final class Base64Utils {
	...
	final static String DATA_IMAGE_BASE64 = "data:image/png;base64,";
    ...
    public static String encodeImage(BufferedImage bufferedImage) {
    	try {
			...
			String b64Image = encodeImage(stream.toByteArray());
			stream.close();
	        return b64Image;
    	}catch (Exception e) {
    		e.printStackTrace();
    ...
    public static String encodeImage(byte[] byteImage) {
    	return DATA_IMAGE_BASE64 + java.util.Base64.getEncoder().encodeToString(byteImage);
    }
