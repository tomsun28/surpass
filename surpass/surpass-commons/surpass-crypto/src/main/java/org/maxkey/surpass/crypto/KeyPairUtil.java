...
import org.maxkey.surpass.crypto.cert.CryptoException;
...
public final class KeyPairUtil
{
	...
	public static int getKeyLength(PublicKey pubKey)
	{
		...
		logger.warn("Don't know how to get key size from key {}" ,pubKey);
		return UNKNOWN_KEY_SIZE;
	}
	...
	public static int getKeyLength(AsymmetricKeyParameter keyParams)
	{
		...
		logger.warn("Don't know how to get key size from parameters {}" , keyParams);
		return UNKNOWN_KEY_SIZE;
	}
}
