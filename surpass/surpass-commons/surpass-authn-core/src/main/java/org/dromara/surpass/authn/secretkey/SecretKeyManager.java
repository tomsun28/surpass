...
package org.dromara.surpass.authn.secretkey;
...
public interface SecretKeyManager {
	...
	public static final String CACHED_KEY_NAME = "login:secretkey:cached";

	public static final String CACHED_KEY_LAST_NAME = "login:secretkey:cached:%s";
