...
package org.dromara.surpass.ldap.constants;
...
public class InetOrgPerson {
	...
	public static final List<String> OBJECTCLASSES = Arrays.asList("top", "person","organizationalPerson",InetOrgPerson.OBJECTCLASS);
