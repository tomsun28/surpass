...
package org.dromara.surpass.ldap;
...
public class LdapUtils {
    ...
    protected DirContext createDirContext(Properties properties) {
        ...
        try {
            ...
            logger.info("connect to ldap {} seccessful.",providerUrl);
        } catch (NamingException e) {
            logger.error("connect to ldap {} fail.",providerUrl);
    ...
    public static String getAttributeStringValue(String attribute ,Map<String,Attribute> attributeMap) throws NamingException {
